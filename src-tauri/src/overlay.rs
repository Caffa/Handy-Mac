...
/// Pill is 45px, margin-top 4px, gap to preview ~15px, and preview text can display ~3 lines
/// with feathered glass styling (padding: 16px 24px, line-height: 1.5).
const OVERLAY_WINDOW_HEIGHT: f64 = 140.0;
